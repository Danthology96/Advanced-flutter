            ...
            Row(
              ...
              children: [
                ...
                CalculatorButton(
                  ...
                  bgColor: Color(0xffA5A5A5),
                  onPressed: () =>
                      calculatorController.changeNegativePositiveNumber(),
                ),
                CalculatorButton(
                  text: 'del',
                  bgColor: Color(0xffA5A5A5),
                  onPressed: () => calculatorController.eraseNumber(),
                ),
                CalculatorButton(
                  text: '/',
                  bgColor: Color(0xffF0A23B),
                  onPressed: () => calculatorController.selectOperator('/'),
                ),
              ],
            ),
            Row(
              ...
              children: [
                ...
                CalculatorButton(
                  text: 'X',
                  bgColor: Color(0xffF0A23B),
                  onPressed: () => calculatorController.selectOperator('X'),
                ),
              ],
            ),
            Row(
            ...
            Row(
              ...
              children: [
                ...
                CalculatorButton(
                  text: '=',
                  bgColor: Color(0xffF0A23B),
                  onPressed: () => calculatorController.performOperation(),
                ),
              ],
            ),
          ],
